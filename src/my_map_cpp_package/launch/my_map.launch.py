...
def generate_launch_description():
    ...
    ##CONFIGS##         'world_path': ['turtlebot3_gazebo', 'worlds', 'turtlebot3_world.world'],
    configs = {
        'map_file' : os.path.join(get_package_share_directory('map_package'), 'all_maps', 'maze_2_map.yaml'), #package_name, map_folder_name, map_name
        'spawn_pose': ['-2', '-0.0025', '-0.00853'], #xyz
        'spawn_orientation': ['4.935', '0.003'], #xy
        'robot_type': 'waffle_pi',
        'world_path': ['worlds_package', 'worlds', 'my_maze_2.world'], #package_name, world_folder_name, world_name
